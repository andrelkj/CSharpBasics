...
public class DataTypesAndVariables
{
    static void Main(string[] args)
    {
        ...
        // int overMemoryNegativeInt = -2,147,483,649; // the error is thrown since the value is over integer memory capacity

        // Console.WriteLine(overMemoryPositiveInt);
        // Console.WriteLine(overMemoryNegativeInt);

        short validShortInteger = 100; // 2 byte memory --> represent 16-bits of memory allocated for single small numbers
